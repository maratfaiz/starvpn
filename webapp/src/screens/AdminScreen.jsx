        ...
        {SUB_TABS.map((t) => {
          ...
          return (
            <button
              ...
              style={{
                background: active ? "rgba(255,184,0,.12)" : "#0D0C0A",
                border: `1px solid ${active ? "rgba(255,184,0,.4)" : "rgba(255,255,255,.06)"}`,
                color: active ? "#FFB800" : "rgba(235,224,204,.55)",
              }}
            >
              {t.label}
            </button>
          ...
          <div className="flex gap-1.5 overflow-x-auto">
            {FILTERS.map((f) => (
              <button
                ...
                style={{
                  background: filter === f.id ? "rgba(255,184,0,.12)" : "#0D0C0A",
                  border: `1px solid ${filter === f.id ? "rgba(255,184,0,.4)" : "rgba(255,255,255,.06)"}`,
                  color: filter === f.id ? "#FFB800" : "rgba(235,224,204,.5)",
                }}
              >
                {f.label}
              </button>
