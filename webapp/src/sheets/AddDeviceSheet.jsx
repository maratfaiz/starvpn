      ...
      <div className="grid grid-cols-2 gap-2.5 mb-5">
        {TYPES.map((t) => {
          ...
          return (
            ...
            >
              <DeviceIcon type={t.deviceIcon} size={22} color={selected ? "#FFB800" : "#F5F3EE"} />
              <span className="font-display font-semibold text-[12.5px]" style={{ color: selected ? "#FFB800" : "#F5F3EE" }}>
                {t.label}
              </span>
            </button>
          );
